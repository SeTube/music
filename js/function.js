    ...
    $(".music-list").on("mousemove",".list-item", function() {
        ...
        if(!$(this).data("loadmenu")) {
            ...
            '<div class="list-menu" data-no="' + num + '">' +
                '<span class="list-icon icon-play bc" data-function="play" title="点击播放这首歌"></span>' +
                '<span class="list-icon icon-download bc" data-function="download" title="点击下载这首歌"></span>' +
                '<span class="list-icon icon-share bc" data-function="share" title="点击分享这首歌"></span>' +
            '</div>';
            target.html(html);
...
//提示
 tippy('.bc', { allowTitleHTML: true, animation: 'shift-away', arrow: true, theme: 'light', })
